 ...
 */
public class secretquest extends javax.swing.JFrame {

    /**
     * Creates new form secretquest
     */
    public secretquest() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        AccountsPanel acb = new AccountsPanel();
        this.dispose();
        acb.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(secretquest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new secretquest().setVisible(true);
            }
        });
    }
